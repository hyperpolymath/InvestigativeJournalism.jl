...
This document describes the governance model for
...
InvestigativeJournalism.Jl follows a *Benevolent Dictator For Life
(BDFL)* governance model. This model is well-suited for solo maintainers
and small project teams where rapid, consistent decision-making is more
