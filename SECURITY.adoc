...
[arabic]
. Navigate to
https://github.com/hyperpolymath/InvestigativeJournalism.jl/security/advisories/new[Report
a Vulnerability]
...
* This repository (`+hyperpolymath/InvestigativeJournalism.jl+`) and all
its code
...
https://github.com/hyperpolymath/InvestigativeJournalism.jl/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/InvestigativeJournalism.jl/discussions[GitHub
Discussions]
...
_Thank you for helping keep InvestigativeJournalism.Jl and its users
safe._ 🛡️
