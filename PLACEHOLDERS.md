...
| Placeholder | Description | Example | Files |
|---|---|---|---|
| `InvestigativeJournalism.Jl` | Human-readable project name | `My Project` | SECURITY.md, CODE_OF_CONDUCT.md, TOPOLOGY.md, STATE.a2ml, Justfile, GOVERNANCE.md, MAINTAINERS.md, flake.guix, devcontainer.json |
| `InvestigativeJournalism.jl` | One-line description | `A tool for X` | flake.guix |
